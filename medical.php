   ...
   ?>
	...
	<section class="section section-stats center">
		...
		<div class="row">
			...
			<a onClick="document.location.href='DiseasePrediction/symp1.php'" class="col s12 m6 l3">
				<div class="card-panel blue lighten-1 white-text center"><br><br>
				...
				<div class="card-content">
					...
					<ul class="collection todos">
						<li class="collection-item">
							<div style="color:green;">Diuretics (twice a day)
						...
						<li class="collection-item">
							<div style="color:green;">Beta Blockers (after breakfast)
								<a href="#" class="secondary-content delete">
									<i class="material-icons">close</i>
								</a>
							</div>
